        ...
        <div className="setup-content">
          ...
          <div className="desc">
            <div className="content">
              <h1 style={{ color: "white" }}>Connect to Docker Hub</h1>
              <p style={{ color: "white" }}>
                Pull and run private Docker Hub images by connecting your Docker
                Hub account to Docker GUI.
              </p>
            </div>
          </div>
        </div>
