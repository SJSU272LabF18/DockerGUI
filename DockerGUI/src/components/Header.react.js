...
var Header = React.createClass({
  ...
  handleUserClick: function(e) {
    ...
    menu.append(
      new MenuItem({ label: "Sign Out", click: this.handleLogoutClick })
    );
    menu.popup(
      ...
      username = (
        <div className="login-wrapper">
          <div className="login no-drag" onClick={this.handleUserClick}>
            ...
            <span
              className="text"
              style={{ color: "#20252b", fontSize: "14px" }}
            >
              {this.state.username}
      ...
      username = (
        <div className="login-wrapper">
          <div className="login no-drag" onClick={this.handleLoginClick}>
            <span className="icon icon-user" style={{ color: "#20252b" }} />
            <span style={{ color: "#20252b", fontSize: "14px" }}>LOGIN</span>
          </div>
        </div>
      );
    }
