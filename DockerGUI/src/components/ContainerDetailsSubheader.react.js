...
var ContainerDetailsSubheader = React.createClass({
  ...
  disableRun: function() {
    ...
    return (
      ...
      !this.props.defaultPort ||
      this.props.container.State.Updating
    );
  },
  disableRestart: function() {
    ...
    return (
      this.props.container.State.Stopping ||
      this.props.container.State.Downloading ||
      this.props.container.State.Restarting ||
      this.props.container.State.Updating
    );
  },
  disableStop: function() {
    ...
    return (
      this.props.container.State.Stopping ||
      this.props.container.State.Downloading ||
      this.props.container.State.ExitCode ||
      !this.props.container.State.Running ||
      this.props.container.State.Updating
    );
  },
  ...
  handleTerminal: function() {
    if (!this.disableTerminal()) {
      ...
      dockerMachineUtil.dockerTerminal(
        `docker exec -it ${this.props.container.Name} ${shell}`
      );
    }
  },
  render: function() {
    ...
    if (this.disableStop()) {
      startStopToggle = (
        <div className={startActionClass}>
          <div className="action-icon start" onClick={this.handleStart}>
            <span
              className="icon icon-start"
              style={{ color: "#944d4d", fontWeight: "800" }}
            />
          </div>
      ...
      startStopToggle = (
        <div className={stopActionClass}>
          <div className="action-icon stop" onClick={this.handleStop}>
            <span
      ...
      <div className="details-subheader">
        <div className="details-header-actions">
          ...
          <div className={restartActionClass}>
            <div className="action-icon" onClick={this.handleRestart}>
              <span
          ...
          <div className={terminalActionClass}>
            <div className="action-icon" onClick={this.handleTerminal}>
              <span
                className="icon icon-docker-exec"
                style={{ color: "#944d4d", fontWeight: "800" }}
              />
            </div>
          ...
          {/* <div className={docsActionClass}>
            <div className="action-icon" onClick={this.handleDocs}>
        ...
        <div className="details-subheader-tabs">
          <span className={tabHomeClasses} onClick={this.showHome}>
            Home
          </span>
